...
@Composable
fun LockedNoteScreen(
    viewModel: MainViewModel = hiltViewModel(),
    navController: NavHostController
) {
    val uiState = viewModel.lockedNoteListState.collectAsStateWithLifecycle().value
            ...
            when (uiState) {
                ...
                is UiState.Success -> {
                    if (uiState.data.isEmpty())
                        EmptyWidget(R.drawable.lock, "No Lock Notes")
                    else
